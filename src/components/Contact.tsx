        ...
        <div className="max-w-2xl mx-auto">
          <div className="p-8 bg-gray-50 dark:bg-slate-700 rounded-lg shadow-lg">
            ...
            <div className="flex justify-center gap-4 mt-8">
              <a href="https://github.com/aksingh-77" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://www.linkedin.com/in/aniket-kumar-sinha-55925b202/" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://twitter.com/Aniket_Sinha_" target="_blank" rel="noopener noreferrer" 
